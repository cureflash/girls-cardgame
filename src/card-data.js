...
export const CHARACTERS = {
  ...
  kyoko: { id: 'kyoko', name: '佐倉杏子', passive: '初期手札が1枚少ない', openingHandModifier: -1, special: '相手の使い魔・魔女1体を生贄にして魔女召喚', image: null },
  homura: { id: 'homura', name: '暁美ほむら', passive: '初期手札が3枚多い', openingHandModifier: 3, special: '発動ターン中、相手はチェーン不可', image: null },
};
const SKINS = {
  madoka: {
